  ...
  <table class="table1">
    <thead class="">
      <tr>
        ...
        <th> </th>
        <th>Makanan</th>
        <th> <a href="tambah_makanan.php"><button class="btn btn-primary my-2 my-sm-0">Tambah</button></a></th>
      </tr>
    </thead>
    ...
    <div>
      ...
      <?php while ($row = mysqli_fetch_assoc($menu)) { ?>
        ...
        <tr>
          ...
          <td></td>
          <td>
            <a href="ubah.php?menu=<?= $row['menu'] ?>"><button class=""><b>Ubah</b></button></a>
            <a href="hapus.php?menu=<?= $row['menu'] ?>"><button class=""><b>Hapus</b></button></a>
          </td>
          <td></td>
        </tr>
        <?php $i++; ?>
