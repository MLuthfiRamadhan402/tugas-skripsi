...
$menu = mysqli_query($koneksi, "SELECT * FROM minuman  ");
  ...
  <table class="table1">
    <thead class="">
      <tr>
        ...
        <th> </th>
        <th>Minuman</th>
        <th> <a href="tambah_minuman.php"><button class="btn btn-primary my-2 my-sm-0">Tambah</button></a></th>
      </tr>
    </thead>
    ...
    <div>
      ...
      <?php while ($row = mysqli_fetch_assoc($menu)) { ?>
        ...
        <tr>
          ...
          <td></td>
          <td>
            <a href="ubah_minuman.php?menu=<?= $row['menu'] ?>"><button class=""><b>Ubah</b></button></a>
            <a href="hapus_minuman.php?menu=<?= $row['menu'] ?>"><button class=""><b>Hapus</b></button></a>
          </td>
          <td></td>
        </tr>
        <?php $i++; ?>
