...
if($nama === $cek['menu']){ 
		...
		window.location.href('tambah_kue.php');
	...
	mysqli_query($koneksi, "INSERT INTO kue VALUES(
			'',
			'$nama',
			'$harga'
	...
	mysqli_query($koneksi, "INSERT INTO stok_kue VALUES(
			'',
			'$nama',
			'$satuan',
			'$harga'
...
<body>
	...
	<div style="margin-left: 92%;">
		<a href="kue.php"><button>Kembali</button></a>
	</div>
	<center>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				...
				<legend align=cemter;><b>Tambah Menu kue</b></legend>
				<div class="label">
