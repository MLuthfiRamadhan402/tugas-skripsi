...
<body>
	...
	<div style="display: flex;">
		...
		<main class="main">
			<h1 style="padding: 15px;">Stok Bahan Pokok</h1>
  ...
  <thead>
    <tr>
      ...
      <th>Harga</th>
      <th>Aksi</th>
      <th><a href="tambahbhn.php"><button>Tambah</button></a></th>
  ...
  <div>
    ...
    <tr>
      ...
      <td><?=$row['satuan'] ?></td>
      <td><?=$row['harga'] ?></td>
      <td><a href="ubah_bahanpokok.php?id=<?= $row['id']; ?>"><button style="margin: 10px">Ubah</button></a> <a href="tambah_bahanpokok.php?id=<?= $row['id']; ?>"><button style="margin:  10px">Tambah</button></a>
      	<a href="hapus_bahanpokok.php?id=<?= $row['id']; ?>"><button style="margin:  10px">Hapus</button></a>
      </td>
    </tr>
    <?php $a++; ?>
  <?php } ?>
