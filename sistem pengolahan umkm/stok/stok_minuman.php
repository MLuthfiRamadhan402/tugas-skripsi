...
$st=mysqli_query($koneksi,"SELECT * FROM stok_minuman ");
...
<body>
	...
	<div style="display: flex;">
		...
		<main class="main">
			<h1 style="padding: 15px;">Stok Minuman</h1>
  ...
  <div>
    ...
    <tr>
      ...
      <td><?=$row['satuan'] ?></td>
      <td><?=$row['harga'] ?></td>
      <td><a href="ubah_minuman.php?menu=<?= $row['menu']; ?>"><button style="margin: 10px">Ubah</button></a> <a href="tambah_minuman.php?menu=<?= $row['menu']; ?>"><button style="margin: ; 10px">Tambah</button></a></td>
    </tr>
    <?php $a++; ?>
  <?php } ?>
