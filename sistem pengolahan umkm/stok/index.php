...
$st=mysqli_query($koneksi,"SELECT * FROM stok_makanan");
...
<body>
  ...
  <div style="display: flex;">
    ...
    <main class="main">
      <h1 style="padding: 15px;">Stok Makanan</h1>
  ...
  <div>
    ...
    <tr>
      ...
      <td><?=$row['satuan'] ?></td>
      <td><?=$row['harga'] ?></td>
      <td><a href="ubah.php?menu=<?= $row['menu']; ?>"><button style="margin: 10px">Ubah</button></a> <a href="tambah.php?menu=<?= $row['menu']; ?>"><button style="margin: ; 10px">Tambah</button></a></td>
    </tr>
    <?php $a++; ?>
  <?php } ?>
