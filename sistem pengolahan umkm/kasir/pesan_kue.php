...
if ($menu === $_GET['menu']) {
	$mn = mysqli_query($koneksi,"SELECT * FROM kue WHERE menu='$menu' ");
	...
	if (isset($_POST['submit'])) {
		...
		$aa = mysqli_query($koneksi, "SELECT * FROM stok_kue WHERE menu='$menu'");
 ...
 ");
		...
		// update data satuan di databases tabel stok kue
		mysqli_query($koneksi, "UPDATE stok_kue SET satuan='$total' 
		WHERE menu='$menu'
 ");
...
<body>
	<form action="" method="post" enctype="multipart/form-data">
		...
		<fieldset style="width: 400px; margin:auto; margin-top: 50px;">
			...
			<legend align=cemter;><b>Menu Kue</b></legend>
