...
// menapilkan data pesan dan menu
	...
	<div style="display: flex;">
		<aside class="side">
			<div style="padding: 15px;">
				<a href="index.php"><button >Makanan</button></a>
			</div>
			<div style="padding: 15px;">
			...
			<h1>Kasir</h1>
			 ...
			 <div style="padding-bottom: 15px; padding-left: 5px;padding-top: 15px;">
                    ...
                    <?php while ($rows = mysqli_fetch_assoc($menu)) { ?>
                        <button style="padding-left: 5px;"><a class="dropdown-item" href="pesan.php?menu=<?= $rows['menu']; ?>"><?= $rows['menu'] . ' ' . $rows['harga']; ?></a></button>
                    <?php } ?>
                </div>
